...
class Approve(unittest.TestCase):
    ...
    def test_2_login(self):
        ...
        driver.find_element_by_xpath("//*[@id='login_with_account']/div[1]/input").send_keys("approve1")
        time.sleep(0.3)
    ...
    def test_4_Clickmenu(self):
        driver = self.driver
        driver.find_element_by_xpath("//*[@id='my-approval-header-page']").click()

    def test_5_clicktikcet(self):
        driver = self.driver
        driver.find_element_by_css_selector("[title='ádasdasd']").click()
